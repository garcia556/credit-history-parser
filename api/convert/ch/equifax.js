...
function convert(obj)
{
	...
	let r = {};
	r = oa(r, subset(obj.bki_response	, [ "responsecode", "responsestring" ]	));
	...
	if (root)
	{
		...
		{
			r["base_part.addr_reg"]		= null;
			r["base_part.addr_fact"]	= null;

			r["base_part.pboul.pboul_no"]		= null;
			r["base_part.pboul.pboul_date"]		= null;
			r["base_part.pboul.pboul_place"]	= null;
		}

		if (root.add_part.interest)
			r = oa(r, subset(root.add_part.interest		, [ "hour", "day", "week", "month", "quarter", "year" ]														, "add_part.interest."		));
		else
		{
			r["add_part.interest.hour"]		= null;
			r["add_part.interest.day"]		= null;
			r["add_part.interest.week"]		= null;
			r["add_part.interest.month"]	= null;
			r["add_part.interest.quarter"]	= null;
			r["add_part.interest.year"]		= null;
		}

		if (root.add_part.own_interest)
			r = oa(r, subset(root.add_part.own_interest	, [ "hour", "day", "week", "month", "quarter", "year" ]														, "add_part.own_interest."	));
		else
		{
			r["add_part.own_interest.hour"]		= null;
			r["add_part.own_interest.day"]		= null;
			r["add_part.own_interest.week"]		= null;
			r["add_part.own_interest.month"]	= null;
			r["add_part.own_interest.quarter"]	= null;
			r["add_part.own_interest.year"]		= null;
		}

		if (root.add_part.attrs)
		...
		if (root.add_part.info_requests)
